...
results = {
    "Tuned KNN": [0.575, 0.590, 0.575, 0.570],
...
line_colors = {"Tuned KNN": "C0", "SVM": "C1", "Random Forest": "C2", "Neural Network": "C3"}
...
plt.savefig("comparison_tuned_all_models_by_features.png", dpi=300, bbox_inches="tight")
plt.close()
...
plt.savefig("comparison_final_best_accuracy_by_model.png", dpi=300, bbox_inches="tight")
plt.close()
...
plt.savefig("comparison_final_40_mfcc_features.png", dpi=300, bbox_inches="tight")
plt.close()
...
plt.tight_layout()
plt.savefig("comparison_final_accuracy_heatmap.png", dpi=300, bbox_inches="tight")
plt.close()
